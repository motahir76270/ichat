...
var _excluded2 = ["action", "children", "value", "disabled", "onChange", "onClick", "onFocus", "component", "orientation", "variant", "color", "disableIndicator", "indicatorPlacement", "indicatorInset", "slots", "slotProps"];
...
var Tab = React3.forwardRef(function Tab2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyTab"
  });
  ...
  const tabRef = React3.useRef(null);
...
true ? Tab.propTypes = {
   ...
   * @default false
   */
  disableIndicator: import_prop_types2.default.bool,
  /**
   * If `true`, the indicator stay within the padding based on the `Tabs` orientation.
   * @default false
   */
  indicatorInset: import_prop_types2.default.bool,
  /**
   * The indicator's position when the Tab is selected.
   * @default row ? 'bottom' : 'right'
   */
  indicatorPlacement: import_prop_types2.default.oneOf(["bottom", "left", "right", "top"]),
  /**
...
//# sourceMappingURL=chunk-Q3N2MEAD.js.map
