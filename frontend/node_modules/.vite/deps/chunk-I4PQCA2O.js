...
var _excluded2 = ["component", "children", "variant", "color", "size", "disableUnderline", "underlinePlacement", "tabFlex", "sticky", "slots", "slotProps"];
...
var TabList = React8.forwardRef(function TabList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyTabList"
  });
  const tabsSize = React8.useContext(SizeTabsContext_default);
  const {
    isRtl,
    orientation,
    getRootProps,
  ...
  return (
    ...
    (0, import_jsx_runtime3.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime3.jsx)(TabsListProvider, {
        value: contextValue,
...
true ? TabList.propTypes = {
   ...
   */
  sticky: import_prop_types2.default.oneOf(["bottom", "top"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   */
  tabFlex: import_prop_types2.default.oneOfType([import_prop_types2.default.number, import_prop_types2.default.string]),
  /**
   * The placement of the TabList's underline.
   * @default orientation === 'horizontal' ? 'bottom' : 'right'
   */
  underlinePlacement: import_prop_types2.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * The [global variant](https://mui.com/joy-ui/main-features/global-variants/) to use.
   * @default 'plain'
   */
...
//# sourceMappingURL=chunk-I4PQCA2O.js.map
